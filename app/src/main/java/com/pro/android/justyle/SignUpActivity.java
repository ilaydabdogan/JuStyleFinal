...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewSignIn.setOnClickListener(new View.OnClickListener(){
             ...
             *          this onClick starts the LoginActivity
             */
            @Override
        ...
        mRegisterButton.setOnClickListener(new View.OnClickListener(){
             ...
             * @param v is the position that the onClick requires on the UI for the method to be called
             *          onClick method calls a method when its corresponding UI item is pressed
             *          this onClick calls the method registerUser
             */
            @Override
            public void onClick(View v){
                registerUser();
    ...
    /**
     * registerUser checks the EditText fields, mEditTextEmail, mEditTextPassword and mConfirmPassword
     * and uses these fields to call the FireBase method createUserWithEmailAndPassword and then
     * starts the FrontPageActivity as the user is now logged in as well as has a profile
     */
    private void registerUser(){
        ...
        if (!password.equals(passwordConfirmed)){
            Toast.makeText(this, "Password Confirmation must match password",
